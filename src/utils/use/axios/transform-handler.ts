...
const transformHandler: (transformParams?: Partial<CreateAxiosOptions>) => AxiosTransform = (transformParams?: Partial<CreateAxiosOptions>) => {
  ...
  const newTransformRequestData = transform?.transformRequestData as Function;
  const newRequestInterceptors = transform?.requestInterceptors as Function;
  ...
  /**
    ...
    transformRequestData: (
      ...
      newTransformRequestData(res, options);
      ...
      if (code === ResultEnum.SUCCESS)
        return filterResult ? data : resData;
    ...
    requestInterceptors: (config: AxiosRequestConfig) => {
      return newRequestInterceptors(config);
    },
